...
using LearningAboutMigrations.Models;

namespace LearningAboutMigrations.Controllers
{
    public class GameScoresController : Controller
    {
        private LearningAboutMigrationsContext db = new LearningAboutMigrationsContext();
        ...
        public ActionResult Create([Bind(Include = "ID,Name,Points,Team")] GameScore gameScore)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,Name,Points,Team")] GameScore gameScore)
        {
            if (ModelState.IsValid)
            {
